(function() {
	...
	view = (function() {
		...
		return {
			...
			progressUnzip : function(current, total) {
	...
	view.onEntryClick = function(entry) {
		controller.getEntryFile(entry, view.getEntryFile, view.progressUnzip);
	};
