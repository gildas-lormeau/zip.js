...
declare module 'zip.js' {
	...
	export function createReader(reader: Reader, callback: (zipReader: ZipReader) => void, onerror?: (error: any) => void): void;

	export class ZipReader {
		getEntries(callback: (entries: Entry[]) => void): void;
	...
	export interface Entry {
		...
		getData(writer: Writer, onend: (result: any) => void, onprogress?: (progress: number, total: number) => void, checkCrc32?: boolean): void;
	}
	...
	export function createWriter(writer: Writer, callback: (zipWriter: ZipWriter) => void, onerror?: (error: any) => void, dontDeflate?: boolean): void;
	...
	export class ZipWriter {
		public add(name: string, reader: Reader, onend: () => void, onprogress?: (progress: number, total: number) => void, options?: WriteOptions): void;
