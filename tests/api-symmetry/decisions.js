...
const ENTRY_PROPERTIES = {
	...
	rawLastModDate: { options: ["rawLastModDate", "lastModDate"], note: "the MS-DOS encoding of the date, or the rawLastModDate option verbatim" },
...
const WRITER_OPTIONS = {
	...
	rawLastModDate: { properties: ["rawLastModDate"], note: "writes the MS-DOS date verbatim, bypassing the lastModDate encoding" },
