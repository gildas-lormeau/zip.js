export default ([
	...
	{ title: "Filesystem check password", script: "./test-fs-check-password.js", env: ["deno", "browser"] },
	...
	{ title: "Pako (no worker)", script: "./test-pako-no-worker.js", env: ["node", "browser", "deno"]  },
