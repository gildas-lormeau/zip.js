...
export default ([
	...
	{ title: "Abort signal (buffered flush offset)", script: "./test-abort-buffered-flush-offset.js", features: ["pipeToSignal"] },
	{ title: "Abort signal (already aborted)", script: "./test-abort-signal-pre-aborted.js" },
	...
	{ title: "Temp stream dispose hook", script: "./test-temp-stream-dispose.js", features: ["pipeToSignal"] },
	...
	{ title: "Deflate64 (output buffer boundary)", script: "./test-deflate64-buffer-boundary.js" },
	...
	{ title: "Filesystem export metadata", script: "./test-fs-export-metadata.js" },
	...
	{ title: "Filesystem File System handle error identity", script: "./test-fs-handle-error-identity.js", features: ["pipeToSignal"] },
	...
	{ title: "Prevent close", script: "./test-prevent-close.js" },
	...
	{ title: "Split zip file (strictness)", script: "./test-split-zip-strictness.js" },
	{ title: "Golden output", script: "./test-golden-output.js" },
	{ title: "Store", script: "./test-store.js" },
	{ title: "Streams", script: "./test-streams.js" },
	{ title: "Terminate workers", script: "./test-terminate-workers.js" },
