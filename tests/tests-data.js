export default ([
	...
	{ title: "Filesystem check password", script: "./test-fs-check-password.js", env: ["deno", "browser", "bun"] },
	{ title: "Filesystem export", script: "./test-fs-export-options.js", env: ["deno", "browser", "bun"] },
	{ title: "Filesystem HTTP import", script: "./test-fs-http-import.js", env: ["deno", "browser", "bun"] },
	{ title: "Filesystem HTTP reader", script: "./test-fs-http-reader.js", env: ["deno", "browser", "bun"] },
	{ title: "Filesystem metadata", script: "./test-fs-metadata.js", env: ["deno", "browser", "bun"] },
	{ title: "Filesystem replace entry", script: "./test-fs-replace.js", env: ["deno", "browser", "bun"] },
	{ title: "Filesystem streams", script: "./test-fs-streams.js" },
	{ title: "Filesystem text", script: "./test-fs-text.js" },
	{ title: "Filesystem unzip uncompressed file", script: "./test-fs-unzip-store.js", env: ["deno", "browser", "bun"] },
	{ title: "Filesystem test", script: "./test-fs.js" },
	{ title: "HTTP crypto", script: "./test-http-crypto.js", env: ["deno", "browser", "bun"] },
	{ title: "HTTP split file", script: "./test-http-split-zip.js", env: ["deno", "browser", "bun"] },
	{ title: "HTTP zip64", script: "./test-http-zip64.js", env: ["deno", "browser", "bun"] },
	{ title: "Invalid CRC", script: "./test-invalid-crc.js", env: ["deno", "browser", "bun"] },
	...
	{ title: "Readable Zip Stream", script: "./test-readable-zip-stream.js", env: ["deno", "browser", "bun"] },
