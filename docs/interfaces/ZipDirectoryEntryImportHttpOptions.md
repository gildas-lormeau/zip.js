...
> `optional` **duplicates?**: `"throw"` \| `"keep-first"` \| `"keep-last"`
...
[`ZipDirectoryEntryImportOptions`](ZipDirectoryEntryImportOptions.md).[`passwords`](ZipDirectoryEntryImportOptions.md#passwords)
...
[`ZipDirectoryEntryImportOptions`](ZipDirectoryEntryImportOptions.md).[`requestPassword`](ZipDirectoryEntryImportOptions.md#requestpassword)
