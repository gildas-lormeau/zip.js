...
compared exactly, after [GetEntriesOptions#normalizeFilename](#normalizefilename): two names differing only by letter case or
...
UTF-8 is detected when the option is not set, see [GetEntriesOptions#filenameEncoding](#filenameencoding).
